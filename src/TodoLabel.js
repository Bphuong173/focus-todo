...
.then(response => response.json())
  ...
  return (
    <>
    <h2 className="TodoH2">Todo label</h2>
    <div className="inputTodoLabel">
      <input type="text" placeholder="Thêm vào công việc " value = {textInput} onChange={TextInputChange}></input>
